...
public class Calculator
{
    ...
    private static class Hierarki
    {
        public int inputSymbol;
        public int topOfStack;

        public Hierarki( int inSymbol, int topSymbol )
        {
    ...
    private static Hierarki [ ] precTable = new Hierarki[ ]
    {
        new Hierarki(   0, -1 ),  // EOL
        new Hierarki(   0,  0 ),  // VALUE
        new Hierarki( 100,  0 ),  // OPAREN
        new Hierarki(   0, 99 ),  // CPAREN
        new Hierarki(   6,  5 ),  // EXP
        new Hierarki(   3,  4 ),  // MULT
        new Hierarki(   3,  4 ),  // DIV
        new Hierarki(   2,  0 ),  // MULTMINUS
        new Hierarki(   1,  2 ),  // PLUS
        new Hierarki(   1,  2 )  // MINUS
    };
    ...
    public Calculator( String s )
    {
        ...
        str = new StringTokenizer( s, "+*-/^()_ ", true );
